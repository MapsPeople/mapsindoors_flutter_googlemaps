...
class ExamplePositionProvider extends MPPositionProviderInterface {
  ...
  void updatePosition(MPPoint pos,
      {num? accuracy, num? bearing, int? floorIndex}) {
...
class ExamplePositionResult extends MPPositionResultInterface {
  ExamplePositionResult(this.provider,
      {this.accuracy, this.bearing, this.floorIndex, this.point});
